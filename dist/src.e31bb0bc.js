...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"nav_menus.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.navHover = void 0;
var menu_items = document.querySelectorAll('nav ul a');
var navHover = exports.navHover = function navHover() {
  menu_items.forEach(function (items) {
    items.classList.add('inactive');
    items.addEventListener('mouseover', function () {
      items.classList.remove('inactive');
      menu_items.forEach(function (active_items) {
    ...
    items.addEventListener('mouseleave', function () {
      items.classList.add('inactive');
      menu_items.forEach(function (active_items) {
        var active_id = active_items.getAttribute('data-id');
        if (active_id == 'active') {
...
var carousel = exports.carousel = function carousel() {
  var carousel_trey = document.querySelector('.image_trey');
  var arrow_left = document.querySelector('.arrow_left');
  var arrow_right = document.querySelector('.arrow_right');
  var total_index = document.querySelectorAll('.project').length;
  var featured_circle_nav = document.querySelectorAll('.featured_mini_nav .circle');
  var banner_mini_nav = document.querySelectorAll('.mini_nav .circle');
  var banner_image_trey = document.querySelector('.banner_image_trey');
  var banner_navigation_h2 = document.querySelectorAll('.banner_navigation h2');
  var element_total_count = document.querySelectorAll('.element').length - 1;
  var element_total = document.querySelectorAll('.element');
  var service_left_arrow = document.querySelector('.service_arrow_left');
  var service_right_arrow = document.querySelector('.service_arrow_right');
  var service_heading = document.querySelector('.service h1');
  var service_body_text = document.querySelector('.service p');
  var element_count = 0;
  var rotate_value = 90;
  var start_value = 0;
  var move_value = 60;
  ...
  var value = 0;
  var service_content = [{
    headings: ['Project Management', 'Detailed Engineering Design', 'Conceptual Design and Feasibility Studies', 'Construction Supervision']
  }, {
    contents: ["Project management involves planning, organizing, and overseeing all phases of a project to ensure successful completion.", "\n                Detailed engineering design transforms conceptual plans into precise technical specifications.", "Conceptual design and feasibility studies assess the viability of a project in its early stages.", "\n                Construction supervision ensures that building projects are executed according to plans, specifications, and regulations. "]
  }];

  //Banner carousel codes begin here...
  banner_mini_nav.forEach(function (items, index) {
    items.style.cssText = "\n        width:6px;\n        height:6px;\n        background:transparent\n        ";
    if (index == 0) {
      items.style.cssText = "\n                width:10px;\n                height:10px;\n                background:white\n            ";
    }
    items.onclick = function () {
      banner_mini_nav.forEach(function (banner_nav) {
      ...
      switch (index) {
        case 0:
          ...
          banner_navigation_h2.forEach(function (h2_items, h2_index) {
  ...
  arrow_right.onclick = function () {
    ...
    featured_circle_nav.forEach(function (items, index) {
  ...
  featured_circle_nav.forEach(function (items, index) {
    ...
    items.onclick = function () {
      featured_circle_nav.forEach(function (all_circle) {
  ...
  var items = _gsap.gsap.utils.toArray(".element");
  ...
  service_right_arrow.onclick = function () {
    if (element_count < element_total_count) {
      start_value += rotate_value;
      _gsap.gsap.to('.circle_carousel', {
        rotation: "".concat(start_value),
      ...
      element_total.forEach(function (item, index) {
        var content = item.querySelector('.content');
        _gsap.gsap.to(item, {
          scale: .6
        });
        _gsap.gsap.to(content, {
          opacity: 1
        });
      ...
      element_total.forEach(function (reset, reset_index) {
        var content = reset.querySelector('.content');
        _gsap.gsap.to(reset, {
          scale: 0.6
        });
        _gsap.gsap.to(content, {
...
},{"gsap":"../node_modules/gsap/index.js"}],"projects.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.projectFunctions = exports.projectCarausel = exports.intersetion_observer = exports.galleryCarousel = void 0;
var project_trey = document.querySelector('.project_viewport');
var projects = document.querySelectorAll('.project');
var project_count = document.querySelector('.project_count');
var property_name = document.querySelector('.property_name');
var project_size = document.querySelector('.project_size');
var project_time = document.querySelector('.project_time');
var project_location = document.querySelector('.project_location');
var project_arrow_left = document.querySelector('.project_arrow_left');
var project_arrow_right = document.querySelector('.project_arrow_right');
var projects_trey = document.querySelector('.project_trey');
var totalItems = document.querySelectorAll('.project_trey img').length;
var itemIndex = 1;
var moveValue = 82;
var value = 0;
var projects_count = document.querySelector('.projects_count');
var projects_total = document.querySelector('.projects_total');
var gallery_count = document.querySelector('.gallery_count');
var gallery_total = document.querySelector('.gallery_length');
var gallery_arrow_left = document.querySelector('.gallery_arrow_left');
var gallery_arrow_right = document.querySelector('.gallery_arrow_right');
var gallery_trey = document.querySelector('.gallery_trey');
var gallery_length = document.querySelectorAll('.gallery_trey img').length;
document.addEventListener('DOMContentLoaded', function () {
  projects_total.textContent = '0' + totalItems;
  gallery_total.textContent = '0' + gallery_length;
});
var projectFunctions = exports.projectFunctions = function projectFunctions() {
  var getScrollIndex = function getScrollIndex() {
    var scrollIndex = -1;
    var infinitNumber = Infinity;
    var treyCenter = project_trey.scrollTop + project_trey.offsetHeight / 2;
    projects.forEach(function (items, index) {
      var projectCenter = items.offsetTop + items.offsetHeight / 2;
      var distance = Math.abs(projectCenter - treyCenter);
  ...
  project_trey.addEventListener('scroll', function () {
...
var projectCarausel = exports.projectCarausel = function projectCarausel() {
  console.log(totalItems);
  project_arrow_right.onclick = function () {
    if (itemIndex < totalItems) {
      value += moveValue;
      projects_trey.style.transform = "translateX(-".concat(value, "%)");
      itemIndex++;
      projects_count.textContent = '0' + itemIndex;
    }
  };
  project_arrow_left.onclick = function () {
    if (itemIndex > 1) {
      itemIndex--;
      value -= moveValue;
      projects_trey.style.transform = "translateX(-".concat(value, "%)");
...
var galleryCarousel = exports.galleryCarousel = function galleryCarousel() {
  var gallery_index = 1;
  var gallery_value = 0;
  var gallery_moveValue = 100;
  gallery_arrow_right.onclick = function () {
    if (gallery_index < gallery_length) {
      gallery_value += gallery_moveValue;
      gallery_trey.style.transform = "translateX(-".concat(gallery_value, "%)");
      gallery_index++;
      gallery_count.textContent = '0' + gallery_index;
    }
  };
  gallery_arrow_left.onclick = function () {
    if (gallery_index > 1) {
      gallery_index--;
      gallery_value -= gallery_moveValue;
      gallery_trey.style.transform = "translateX(-".concat(gallery_value, "%)");
...
var intersetion_observer = exports.intersetion_observer = function intersetion_observer() {
  ...
  projectImages.forEach(function (items) {
    observer.observe(items);
  });
  observeArray.forEach(function (items) {
    observer.observe(items);
  });
};
},{}],"images/personnel/managing_director.webp":[function(require,module,exports) {
module.exports = "/managing_director.dc62e710.webp";
},{}],"images/personnel/engineer.webp":[function(require,module,exports) {
module.exports = "/engineer.6939022a.webp";
},{}],"images/personnel/co-founder.webp":[function(require,module,exports) {
module.exports = "/co-founder.3a8e2940.webp";
},{}],"images/personnel/profile_holder.png":[function(require,module,exports) {
module.exports = "/profile_holder.3e24bbcf.png";
},{}],"images/personnel/construction_manager.webp":[function(require,module,exports) {
module.exports = "/construction_manager.be9d53aa.webp";
},{}],"images/personnel/project_manger.webp":[function(require,module,exports) {
module.exports = "/project_manger.c85308f2.webp";
},{}],"images/personnel/structural-engineer.webp":[function(require,module,exports) {
module.exports = "/structural-engineer.bfc04468.webp";
...
exports.personnelFunction = void 0;
var _managing_director = _interopRequireDefault(require("./images/personnel/managing_director.webp"));
var _engineer = _interopRequireDefault(require("./images/personnel/engineer.webp"));
var _coFounder = _interopRequireDefault(require("./images/personnel/co-founder.webp"));
var _profile_holder = _interopRequireDefault(require("./images/personnel/profile_holder.png"));
var _construction_manager = _interopRequireDefault(require("./images/personnel/construction_manager.webp"));
var _project_manger = _interopRequireDefault(require("./images/personnel/project_manger.webp"));
var _structuralEngineer = _interopRequireDefault(require("./images/personnel/structural-engineer.webp"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var personnelFunction = exports.personnelFunction = function personnelFunction() {
  var personnel_container = document.querySelector('.personnel_container');
  var personnel_information = [{
    name: 'Ing Andrew Yeboah Agyemang',
    img: _managing_director.default,
    position: 'Managing Director',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Moses Appiah',
    img: _engineer.default,
    position: 'QA/QC Engineer ',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Kojo Asare',
    img: _coFounder.default,
    position: 'Co-founder /Technical Director',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Priscilla Asare Mensah',
    img: _profile_holder.default,
    position: 'Interior designer',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Godzah Prosper Selasie',
    img: _construction_manager.default,
    position: 'Construction Manager',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Prisca Precious Yeboah',
    img: _project_manger.default,
    position: 'Project Manager',
    email: 'info@structconprojekts.com'
  }, {
    name: 'Marco Antic',
    img: _structuralEngineer.default,
    position: 'Associate - Structural Engineer',
    email: 'info@structconprojekts.com'
  }];
  personnel_information.forEach(function (items) {
    var personnel_card = document.createElement('div');
    var template = "\n         <div class=\"personnel\">\n                <div class=\"personnel_image\">\n                    <img src=".concat(items.img, " alt=\"structcon projecks personnel\">\n                </div>\n\n                <div class=\"name_position\">\n                    <p class=\"name\">").concat(items.name, "</p>\n                    <p>").concat(items.position, "</p>\n                </div>\n\n                <div class=\"personnel_email\">\n                    <a href=\"#\">").concat(items.email, "</a>\n                </div>\n\n         </div>\n    ");
    personnel_card.innerHTML = template;
    personnel_container.appendChild(personnel_card);
  });
};
},{"./images/personnel/managing_director.webp":"images/personnel/managing_director.webp","./images/personnel/engineer.webp":"images/personnel/engineer.webp","./images/personnel/co-founder.webp":"images/personnel/co-founder.webp","./images/personnel/profile_holder.png":"images/personnel/profile_holder.png","./images/personnel/construction_manager.webp":"images/personnel/construction_manager.webp","./images/personnel/project_manger.webp":"images/personnel/project_manger.webp","./images/personnel/structural-engineer.webp":"images/personnel/structural-engineer.webp"}],"index.js":[function(require,module,exports) {
"use strict";

var _gsap = require("gsap");
var _nav_menus = require("/nav_menus.js");
var _carousel = require("/carousel.js");
var _projects = require("/projects.js");
var _about = require("/about.js");
try {
  (0, _nav_menus.navHover)();
  (0, _carousel.carousel)();
} catch (error) {
  console.error('Error in navHover or carousel:', error);
}
try {
  (0, _projects.projectFunctions)();
} catch (error) {
  console.error('Error in pro:', error);
}
try {
  (0, _projects.projectCarausel)();
  (0, _projects.galleryCarousel)();
  (0, _projects.intersetion_observer)();
} catch (error) {
  console.error('Error in pc:', error);
}
try {
  (0, _about.personnelFunction)();
} catch (error) {}
},{"gsap":"../node_modules/gsap/index.js","/nav_menus.js":"nav_menus.js","/carousel.js":"carousel.js","/projects.js":"projects.js","/about.js":"about.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {

...
var _managingDirectorWebp = require("./images/personnel/managing_director.webp");
var _managingDirectorWebpDefault = parcelHelpers.interopDefault(_managingDirectorWebp);
var _engineerWebp = require("./images/personnel/engineer.webp");
var _engineerWebpDefault = parcelHelpers.interopDefault(_engineerWebp);
var _coFounderWebp = require("./images/personnel/co-founder.webp");
var _coFounderWebpDefault = parcelHelpers.interopDefault(_coFounderWebp);
var _profileHolderPng = require("./images/personnel/profile_holder.png");
var _profileHolderPngDefault = parcelHelpers.interopDefault(_profileHolderPng);
var _constructionManagerWebp = require("./images/personnel/construction_manager.webp");
var _constructionManagerWebpDefault = parcelHelpers.interopDefault(_constructionManagerWebp);
var _projectMangerWebp = require("./images/personnel/project_manger.webp");
    ...
    const personnel_information = [
        {
            ...
            img: (0, _managingDirectorWebpDefault.default),
            position: "Founder / Project Director",
            email: "info@structconprojekts.com"
        },
        {
            name: "Kojo Asare",
            img: (0, _coFounderWebpDefault.default),
            position: "Co-founder /Technical Director",
            email: "info@structconprojekts.com"
        },
        {
            name: "Prisca Precious Yeboah",
            img: (0, _projectMangerWebpDefault.default),
            position: "Project Manager",
            email: "info@structconprojekts.com"
        },
        {
            name: "Godzah Prosper Selasie",
            img: (0, _constructionManagerWebpDefault.default),
            position: "Construction Manager",
            email: "info@structconprojekts.com"
        },
        {
            name: "Moses Appiah",
            img: (0, _engineerWebpDefault.default),
...
},{}],"11wqI":[function(require,module,exports) {
module.exports = require("3a57e3b84ff64713").getBundleURL("bLxZJ") + "engineer.58319c0a.webp" + "?" + Date.now();

},{"3a57e3b84ff64713":"lgJ39"}],"72VfV":[function(require,module,exports) {
module.exports = require("bcb17baffad955c7").getBundleURL("bLxZJ") + "co-founder.88ebc962.webp" + "?" + Date.now();

},{"bcb17baffad955c7":"lgJ39"}],"4EJQp":[function(require,module,exports) {
module.exports = require("f7bd2737aea7aed9").getBundleURL("bLxZJ") + "profile_holder.408aaabc.png" + "?" + Date.now();

},{"f7bd2737aea7aed9":"lgJ39"}],"5VRYY":[function(require,module,exports) {
module.exports = require("853c43cba5930044").getBundleURL("bLxZJ") + "construction_manager.0cf45916.webp" + "?" + Date.now();

},{"853c43cba5930044":"lgJ39"}],"4abtq":[function(require,module,exports) {
module.exports = require("c4677f2bda6bf0e0").getBundleURL("bLxZJ") + "project_manger.2500a830.webp" + "?" + Date.now();
...
module.exports = require("723d4b9af8292fd2").getBundleURL("bLxZJ") + "interior.f9556038.jpeg" + "?" + Date.now();
